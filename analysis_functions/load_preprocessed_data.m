...
% Load data
if exist(fullfile(params.PreprocessedDataPath,sub,ses,'eeg',[bidsID '_eeg.mat']),'file')
    load(fullfile(params.PreprocessedDataPath,sub,ses,'eeg',[bidsID '_eeg.mat']),'data');
else
