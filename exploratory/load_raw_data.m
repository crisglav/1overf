function data = load_raw_data(params,bidsID)
...
% Load data
if exist(fullfile(params.RawDataPath,sub,ses,'eeg',[bidsID '_eeg.mat']),'file')
    load(fullfile(params.RawDataPath,sub,ses,'eeg',[bidsID '_eeg.mat']),'data');
else

    datapath = fullfile(params.RawDataPath,sub,ses,'eeg',[bidsID '_eeg.eeg']);
    ...
    save(fullfile(params.RawDataPath,sub,ses,'eeg',[bidsID '_eeg.mat']));
end
end