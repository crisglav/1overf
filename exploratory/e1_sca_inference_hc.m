...
randomizations_path = '/rechenmagd3/Experiments/2023_1overf/results/sca/randomizations_e1_hc';
...
saveas(f,fullfile(figures_path,'e1_sca_inference_hc.svg'));

% Save data in csv
t = table(d_orig,sort(prctile(d_rand,50,2)),lowPC,highPC,'VariableNames',{'d_orig','d_median','lowPC','highPC'});
writetable(t, fullfile(sca_path,'e1_sca_inference_hc.csv'));
