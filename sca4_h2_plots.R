...
filename = "C:\\Users\\Cristina\\1overf\\results\\sca\\randomizations_h2\\stats_orig.csv"
stats = read.csv(filename, header = TRUE, sep = ",")
results <- cbind(specifications,stats)

# load data from inference
filename <- "C:\\Users\\Cristina\\1overf\\results\\sca\\sca_h2_inference.csv"
...
pdf("C:\\Users\\Cristina\\1overf\\results\\sca\\sca_h2_plots.pdf")
